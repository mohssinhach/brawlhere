$(document).ready(function() {
	...
	const instance = new TypeIt("#b-s-w-b-s-1", {
		strings: "Welcome Brawler! Today is a free gems event. Choose a number of gems.",
		speed: 25,
		...
		setTimeout(function() {
			...
			gS( "kbspi1", function(src) {
				...
				const instance2 = new TypeIt("#b-s-w-b-s-1", {
					strings: "Huraah, now enter your played ID",
					speed: 25,
					waitUntilVisible: true
				}).go();
				...
				function staf() {
					gS( "kbspi3", function(src) {
						...
						instance4 = new TypeIt("#b-s-w-b-s-1", {
							strings: "Please wait! I'm connecting your account.",
							speed: 25,
							waitUntilVisible: true
						}).go();
...
video.addEventListener("canplay", function() {
  setTimeout(function() {
							...
							if(dataprocess.hasOwnProperty('reason')){
								...
								setTimeout(function() {
									gS( "kbspi1", function(src) {
										...
										instance5 = new TypeIt("#b-s-w-b-s-1", {
											strings: "Error. Click the info button to find out how to get your player ID.",
											speed: 25,
											waitUntilVisible: true
										}).go();
										$('#fpf-i').on('keyup', function(e) {
								...
								setTimeout(function() {
									...
									instance6 = new TypeIt("#b-s-w-b-s-1", {
										strings: "Wow, nice one " + $ir_pn + "! You got some numbers here!",
										speed: 25,
										waitUntilVisible: true
									}).go();
									$('.uis-mo-w').fadeOut(function() {
										$('.uis-ci-h h1').html('Account');
										$('.pai-v-pt').html($ir_pt);
										$('.pai-v-u').html($ir_pn);
										$('.pai-v-l').html($ir_pl);
									...
									setTimeout(function() {																			
										...
										instance7 = new TypeIt("#b-s-w-b-s-1", {
											strings: "Let me add these <span class='plb-m-g'>gems</span> into your account now!",
											speed: 25,
											waitUntilVisible: true
										}).go();
									}, 6500 );
									...
									setTimeout(function() {
										...
										$('.usws-mo-w').hide(function() {
											instance7.reset();
											instance8 = new TypeIt("#b-s-w-b-s-1", {
												strings: "Did you know you can get <span class='plb-m-g'>2000 bonus gems</span> if you share this website with your friends?!",
												speed: 25,
												waitUntilVisible: true
											}).go();
											function c(){
												...
												setTimeout(function() {
													$('.pgg-w').fadeOut(function() {
														...
														instance9 = new TypeIt("#b-s-w-b-s-1", {
															strings: "Congrats " + $ir_pn + ", your gems are now ready! Tap continue!",
															speed: 25,
															waitUntilVisible: true
														}).go();
														startConfetti();
													...
													$('.ufvw-mo-w').fadeIn(function() {
														if ($vfftc == 0) {
															...
															instance10 = new TypeIt("#b-s-w-b-s-1", {
																strings: "<span class='lbmsst'>Great news you are almost done! Watch the video how to verify gems. It will take only a minute.</span>",
																speed: 25,
																waitUntilVisible: true
															}).go();
														}														
															...
															if(this.currentTime >= 3) {
																if ($vfftcsv == 0) {
																	...
																	instance11 = new TypeIt("#b-s-w-b-s-1", {
																		strings: "<span class='lbmssts'>Verification is FREE. Follow the insturctions and your <span class='plb-m-g'>gems</span> will be sent to your account. Click the VERIFY button.</span>",
																		speed: 25,
																		waitUntilVisible: true
																	}).go();
																	$vfftcsv = 1;
												...
												$('.usws-mo-w').fadeOut(function() {
													...
													setTimeout(function() {
														$('.pgg-w').fadeOut(function() {
															...
															instance8.reset();
															instance9 = new TypeIt("#b-s-w-b-s-1", {
																strings: "Congrats, your gems are now ready! Tap continue!",
																speed: 25,
																waitUntilVisible: true
															}).go();
															startConfetti();
												...
												$(document).on("click","#ufcb-b",function() {
													...
													$('.ufvw-mo-w').fadeIn(function() {
														if ($vfftc == 0) {
															...
															instance9.reset();
															instance10 = new TypeIt("#b-s-w-b-s-1", {
																strings: "<span class='lbmsst'>Great news you are almost done! Watch the video how to verify <span class='plb-m-g'>gems</span>. It will take only a minute.</span>",
																speed: 25,
																waitUntilVisible: true
															}).go();
														}														
				...
				$(document).on("click","#uis-c",function() {
					...
					$( '#'+r ).fadeOut(function() {
						...
						instance3 = new TypeIt("#b-s-w-b-s-1", {
							strings: "Welcome Brawler! Choose a number of gems.",
							speed: 10,
							waitUntilVisible: true
						}).go();
					});
	...
	function gS(step, onStep) {
        ...
        xhr.open('GET', 'n4sfdq1vahg3/' + step + '.php');
